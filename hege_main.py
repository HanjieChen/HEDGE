...
import numpy as np
import itertools
import shapley_topdown as sptd
...
def cal_acc_inter(model, data_iter, fileobject, win_size=2, device='cuda'):
    acc, count = 0, 0
...
if __name__ == '__main__':
    ...
    with open('Shapley_topdown_lstm_imdb.txt', 'w') as f:
        test_acc = cal_acc_inter(model, test_iter, f, win_size=2, device=args.device)
