...
#     for batch in eval_dataloader:
        ...
        if vis > -1:
            shap.visualize_tree(batch,tokenizer,vis)
...
parser.add_argument("--output_dir", default='./output/SST', type=str,
...
if __name__ == '__main__':
    ...
    file_name = 'hedge_bert_imdb_' + str(args.start_pos) + '-'+str(args.end_pos)+'.txt'
